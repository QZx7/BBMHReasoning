...
from bbmhr.parlai.agents.local_human.local_human import LocalHumanReasoningAgent
...
def setup_args(parser=None):
    ...
    LocalHumanReasoningAgent.add_cmdline_args(parser, partial_opt=None)
...
def interactive(opt):
    ...
    print(type(agent))
    agent.opt.log()
    human_agent = LocalHumanReasoningAgent(opt)
    # set up world logger
