...
--partner-model-file ~/dialogue_base/blenderbot/model/bbmhr/gpt_1/3B/bbmhr_27B \
--use-reasoning True \
--reasoning-model-name gpt \
--prompt-path ./bbmhr/prompt_templates/nl_utt_level.txt \
--outfile ./eval/self_chat/gpt_1_academic.txt \
...
--reasoning-model-name gpt \
--prompt-path ./bbmhr/prompt_templates/nl_utt_level.txt \
--outfile ./eval/self_chat/gpt_1_job.txt \
...
--reasoning-model-name gpt \
--prompt-path ./bbmhr/prompt_templates/nl_utt_level.txt \
--outfile ./eval/self_chat/gpt_1_friend.txt \
...
--reasoning-model-name gpt \
--prompt-path ./bbmhr/prompt_templates/nl_utt_level.txt \
--outfile ./eval/self_chat/gpt_1_ongoing.txt \
...
--reasoning-model-name gpt \
--prompt-path ./bbmhr/prompt_templates/nl_utt_level.txt \
--outfile ./eval/self_chat/gpt_1_partner.txt \
