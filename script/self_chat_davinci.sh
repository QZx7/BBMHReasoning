...
--outfile ./eval/self_chat/davinci_academic.txt \
...
--reasoning-model-name davinci \
--prompt-path ./bbmhr/prompt_templates/nl_gpt_3.txt \
--outfile ./eval/self_chat/davinci_job.txt \
...
--reasoning-model-name davinci \
--prompt-path ./bbmhr/prompt_templates/nl_gpt_3.txt \
--outfile ./eval/self_chat/davinci_ongoing.txt \
...
--reasoning-model-name davinci \
--prompt-path ./bbmhr/prompt_templates/nl_gpt_3.txt \
--outfile ./eval/self_chat/davinci_partner.txt \
